...
| 주제 | Unsplash Photo ID | 설명 |
|------|-------------------|------|
| TSMC / 반도체 | `photo-1518770660439-4636190af475` | 회로기판/칩 |
| AI / 데이터센터 | `photo-1558494949-ef010cbdcc31` | 서버/네트워크 |
| 주식 투자 전략 | `photo-1611974789855-9c2a0a7236a3` | 주식 차트 |
| NVIDIA / GPU | `photo-1526374965328-7f61d4dc18c5` | GPU/그래픽 |
| 금융/거시경제 | `photo-1611974789855-9c2a0a7236a3` | 금융 차트 |

사용 전 브라우저에서 URL이 실제로 로드되는지 반드시 확인한다.

**❌ 절대 사용 금지**: 차트가 하락하는 모양(우하향 곡선, 빨간 하락 캔들 지배적, 폭락 그래프)이 포함된 이미지는 sentiment와 무관하게 사용하지 않는다. 블로그 전반의 신뢰감과 긍정적 톤을 유지하기 위함이다.
